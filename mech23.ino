...
// リモコンの設定
// 白色リモコン
const uint16_t remoteAddressByte0 = 0x10;
const uint16_t remoteAddressByte1 = 0xEF;
//十字キー
const uint8_t remoteUp    = 0xA0;
const uint8_t remoteDown  = 0x00;
const uint8_t remoteLeft  = 0x10;
const uint8_t remoteRight = 0x80;
//ボタン
const uint8_t remoteA  = 0xF8;
const uint8_t remoteB  = 0x78;
const uint8_t remoteC  = 0x58;
